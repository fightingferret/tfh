...
{  
  ...
  if( change ) {
    fprintf( fp, "A request was entered at forestheart.com to change\n" );
    ...
    fprintf( fp, "A request was entered at forestheart.com to open an\n" );
  ...
  sprintf( tmp,
    "/usr/lib/sendmail -fjmccau@orc.ca -t %s < email.msg",
    account->new_email );
  system( tmp );

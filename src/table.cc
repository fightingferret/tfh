...
entry_data table_entry [ MAX_TABLE-MAX_PLYR_RACE ][ MAX_FIELD ] =
{
...

  {
    ...
    { &nation_table[0].nation[0],                   VAR_INT   },
    { &nation_table[0].nation[1],                   VAR_INT   },
    { &nation_table[0].nation[2],                   VAR_INT   },
    { &nation_table[0].nation[3],                   VAR_INT   },
    { &nation_table[0].nation[4],                   VAR_INT   },
    { &nation_table[0].nation[5],                   VAR_INT   },
    { &nation_table[0].nation[6],                   VAR_INT   },
    { &nation_table[0].nation[7],                   VAR_INT   },
    { &nation_table[0].nation[8],                   VAR_INT   },
    { &nation_table[0].nation[9],                   VAR_INT   },
    { &nation_table[0].nation[10],                  VAR_INT   },
    { &nation_table[0].nation[11],                  VAR_INT   },
    { &nation_table[0].nation[12],                  VAR_INT   },
    { &nation_table[0].nation[13],                  VAR_INT   },
    { &nation_table[0].nation[14],                  VAR_INT   },
    { &nation_table[0].nation[15],                  VAR_INT   },
